...
argumentos.add_argument('login', type=str, required= True, help='The field cannot be left blank')
argumentos.add_argument('senha', type=str, required= True, help='The field cannot be left blank')
...
class UserRegister(Resource):
    ...
    def post(self):
        ...
        if UserModel.find_by_login(dados['login']):
            return{"message": f"Login '{dados['login']}' already exists."}
